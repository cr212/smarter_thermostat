# Contributing to Smarter Thermostat

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to Smarter Thermostat. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this
...
[INLANG Editor](https://inlang.com/editor/github.com/KartoffelToby/smarter_thermostat)
