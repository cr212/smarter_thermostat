...
However, if you would like to use the "local calibration mode", Smarter Thermostat needs to support the thermostat integration of your device and your device needs to support this feature.
...
If your preferred integration isn’t currently available for local calibration please open a [GitHub issue](https://github.com/KartoffelToby/smarter_thermostat/issues).
